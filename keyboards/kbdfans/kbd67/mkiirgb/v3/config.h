...
// combines ENABLE_RGB_MATRIX_BAND_PINWHEEL_VAL with ENABLE_RGB_MATRIX_SPLASH
#    define RGB_MATRIX_KEYREACTIVE_AGP_ENABLED
...
// #    define ENABLE_RGB_MATRIX_SOLID_REACTIVE_CROSSefefefeeeddfeefefeerewre
