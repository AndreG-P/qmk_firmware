...
#define NORTH_LED       (        16 | LED_FLAG_KEYLIGHT  )
#define SOUTH_LED       (        32 | LED_FLAG_KEYLIGHT  )
#define NORTH_MODIFIER  (        16 | LED_FLAG_MODIFIER  )
#define SOUTH_MODIFIER  (        32 | LED_FLAG_MODIFIER  )
#define NORTH_INDICATOR (        16 | LED_FLAG_INDICATOR )
#define SOUTH_INDICATOR (        32 | LED_FLAG_INDICATOR )
